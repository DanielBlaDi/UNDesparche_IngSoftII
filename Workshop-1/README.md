# Workshop 1: Requirements, User Stories, and Story Mapping - UNDesparche

Este repositorio contiene la entrega del primer taller de la asignatura **Ingeniería de Software II (2025-II)**. El objetivo es definir los requerimientos, historias de usuario y la planeación inicial del proyecto **UNDesparche**, un sistema para la gestión centralizada de eventos e implementos recreativos en la Universidad Nacional de Colombia.

## Estructura de la Carpeta `Workshop-1/`
...
*   **Could Have:** Deseables como la visualización en mapa, notificaciones y reservas temporales.

## Equipo de Trabajo (Grupo 6)
*   **Deibyd Santiago Barragan Gaitan** - Equipo de desarrollo
*   **Daniel Estiven Blanco Diaz** - Scrum Master
*   **Víctor Camilo Cañón Castellanos** - Equipo de desarrollo
*   **John Freddy Moreno Alejo** - Equipo de desarrollo
*   **Ricardo Andres Sarmiento Gomez** - Equipo de desarrollo
*   **Erfan Andres Triana Duque** - Product Owner
